...
var $author$project$Main$Model = F3(
	function (zone, time, isSet) {
		return {G: isSet, B: time, F: zone};
	});
...
var $author$project$Main$padTimeString = function (value) {
	return A3($elm$core$String$padLeft, 2, '0', value);
};
...
var $author$project$Main$view = function (model) {
	if (model.G) {
		var second = $author$project$Main$padTimeString(
			$elm$core$String$fromInt(
				A2($elm$time$Time$toSecond, model.F, model.B)));
		var minute = $author$project$Main$padTimeString(
			$elm$core$String$fromInt(
				A2($elm$time$Time$toMinute, model.F, model.B)));
		var hour = $author$project$Main$padTimeString(
			$elm$core$String$fromInt(
				A2($elm$time$Time$toHour, model.F, model.B)));
		return A2(
			$elm$html$Html$h1,
			_List_Nil,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('time no set yet!')
				]));
	}
};
